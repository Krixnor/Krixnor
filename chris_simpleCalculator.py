...
class Calculator():
    ...
    def menu(self):
        ...
        3. Division
        4. Multiplication
        Note: enter the numbers to carry out your operation""")

        self.user = input("enter the number above to carryout your operation: ")
        if self.user.isdigit() is False:
            print("invalid input")
            self.menu()
        elif int(self.user) == 0:
            print("exited")
            exit()
